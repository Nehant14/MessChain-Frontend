...
export default function App() {
  ...
  function renderDashboard() {
    return (
      <View>
        <SectionTitle eyebrow="Bento Overview" title={role === 'admin' ? 'Control the full mess operating system' : role === 'student' ? 'Your service, your claims, your vote' : 'Staff operations at a glance'} subtitle={role === 'admin' ? 'A hybrid command surface that splits standard logging from trusted contract actions.' : role === 'student' ? 'Fast actions, verified receipts, and a deep status trail.' : 'A lightweight overview tuned for daily execution and sync.'} />
